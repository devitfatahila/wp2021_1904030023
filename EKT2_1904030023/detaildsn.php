...
<body>
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      ...
      <hr>
      <ul class="list-group">
      <li class="list-group-item"><img src="image/<?= $dsn['foto_dosen']; ?>" width="100px" alt=""></li>
        ...
        <li class="list-group-item">Pendidikan S1 : <?= $dsn['pendidikans1']; ?></li>
        <li class="list-group-item">Pendidikan S2 : <?= $dsn['pendidikans2']; ?></li>
        <li class="list-group-item">Pendidikan S3 : <?= $dsn['pendidikans3']; ?></li>
